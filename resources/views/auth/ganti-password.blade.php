            ...
            <div class="card-body">
                <form method="POST" action="{{ route('ganti.password.post') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
    <input type="password" name="password_baru_confirmation" id="pw3" class="form-control" placeholder="Ulangi password baru" required>
    <button type="button" class="btn btn-outline-secondary" style="border-radius:0 10px 10px 0"
            onclick="let i=document.getElementById('pw3');i.type=i.type==='password'?'text':'password'">
        <i class="bi bi-eye"></i>
    </button>
</div>
                    </div>
